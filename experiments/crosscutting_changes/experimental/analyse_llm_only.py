...
from experiments.crosscutting_changes.helper.baseline_methods_Tinnes import _graph_to_dict_general
...
from experiments.crosscutting_changes.helper.HELPER_node_emb import compute_similarity_to_recent_change
from experiments.crosscutting_changes.helper.HELPER_construct_graph_from_uml import create_graph, generate_subgraphs, get_colored_subgraph, parse_puml
...
for filename in os.listdir(folder):
    ...
    json_recent_change =json.dumps(_graph_to_dict_general(recent_focus_point, recent_focus_point.name), indent=4)
    json_current_focus =[( current_focus_subgraph[0], json.dumps(_graph_to_dict_general(current_focus_subgraph[1], current_focus_subgraph[1].name), indent=4))for current_focus_subgraph in current_focus_subgraphs ]
